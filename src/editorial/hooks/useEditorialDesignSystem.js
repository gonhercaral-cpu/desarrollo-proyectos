...
export function useEditorialDesignSystem({ project, documentId }) {
  ...
  return {
    ...
    componentsById,
    stylesById,
    error: mastersState.error || componentsState.error || stylesState.error || templatesState.error || variablesState.error,
  };
}
